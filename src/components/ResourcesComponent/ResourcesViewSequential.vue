                    ...
                    <div class="resource-content">
                        ...
                        <div class="resource-media">
                            <div v-if="resources[currentIndex].url === 'PrepositionOfTimeIllustrationlow'">
                                <img src="../../learning_resources/timeilustrationlow.png" alt="imagen"
                                    style="max-height: 100%;">
                                <!-- <vue-pdf-embed :source="fileSource" /> -->


                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimesimulationslow'"
                                class="h5p-container">
                                <iframe src="https://h5p.org/h5p/embed/1462757" width="1090" height="337" frameborder="0"
                                    allowfullscreen="allowfullscreen"
                                    allow="geolocation *; microphone *; camera *; midi *; encrypted-media *"
                                    title="QUESTION preposition place nivel 3"></iframe>

                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimequestions_and_answerslow'"
                                class="h5p-container">
...
encrypted-media *" title="PREPOSITIONS OF TIME QN1"></iframe>
                            ...
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimelecturelow'">
                                <img src="../../learning_resources/timelecturelow_page-0001.jpg" alt="imagen"
                                    style="max-height: 100%;">
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimeIllustrationmedium'">
                                <img src="../../learning_resources/timeilustrationmedium.png" alt="imagen"
                                    style="max-height: 100%;">
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimesimulationsmedium'"
                                class="h5p-container">
                                <iframe src="https://h5p.org/h5p/embed/1442486" width="1088" height="707" frameborder="0"
                                    allowfullscreen="allowfullscreen" allow="geolocation *; microphone *; camera *; midi *;
encrypted-media *" title="PREPOSITIONS OF TIME N1"></iframe>
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimequestions_and_answersmedium'"
                                class="h5p-container">
...
encrypted-media *" title="PREPOSITIONS OF TIME QN2"></iframe>
                            ...
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimelecturemedium'">
                                <img src="../../learning_resources/timelecturemedium_page-0001.jpg" alt="imagen"
                                    style="max-height: 100%;">
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimeIllustrationhigh'">
                                <img src="../../learning_resources/timeilustrationhigh.png" alt="imagen"
                                    style="max-height: 100%;">
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimesimulationshigh'"
                                class="h5p-container">
                                <iframe src="https://h5p.org/h5p/embed/1442430" width="1088" height="475" frameborder="0"
                                    allowfullscreen="allowfullscreen" allow="geolocation *; microphone *; camera *; midi *;
encrypted-media *" title="PREPOSITIONS OF TIME N3"></iframe>
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimequestions_and_answershigh'"
                                class="h5p-container">
                                <iframe src="https://h5p.org/h5p/embed/1444607" width="1090" height="463" frameborder="0"
                                    allowfullscreen="allowfullscreen" allow="geolocation *; microphone *; camera *; midi *;
encrypted-media *" title="PREPOSITIONS OF TIME QN3"></iframe>
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfTimelecturehigh'">
                                <img src="../../learning_resources/timelecturehigh_page-0001.jpg" alt="imagen"
                                    style="max-height: 100%;">

                            </div>
                            <div v-else-if="resources[currentIndex].url === 'PrepositionOfPlaceIllustrationlow'">
                                <img src="../../learning_resources/placeilustrationlow.png" alt="imagen"
                                    style="max-height: 100%;">
                            </div>

                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfPlacesimulationslow'"
                                class="h5p-containerrr">
...
encrypted-media *" title="PREPOSITIONS OF TIME N3"></iframe>
                                ...
                                <!-- <iframe src="https://h5p.org/h5p/embed/1456138" width="1091" height="892" frameborder="0" allowfullscreen="allowfullscreen" allow="geolocation *; microphone *; camera *; midi *; encrypted-media *" title="PREPOSITIONS OF PLACE S1"></iframe> -->
                            </div>



                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfPlacequestions_and_answerslow'"
                                class="h5p-containerr">
                                <iframe src="https://h5p.org/h5p/embed/1456116" width="1091" height="803" frameborder="0"
                                    allowfullscreen="allowfullscreen"
                                    allow="geolocation *; microphone *; camera *; midi *; encrypted-media *"
                                    title="PREPOSITIONS OF PLACE 1"></iframe>
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfPlacelecturelow'">
                                <img src="../../learning_resources/placelecturelow_page-0001.jpg" alt="imagen"
                                    style="max-height: 100%;">

                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfPlaceIllustrationmedium'">
                                <img src="../../learning_resources/placeilustrationmeium.png" alt="imagen"
                                    style="max-height: 100%;">
                            </div>

                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfPlacesimulationsmedium'"
                                class="h5p-container">
                                <iframe src="https://h5p.org/h5p/embed/1456151" width="1086" height="976" frameborder="0"
                                    allowfullscreen="allowfullscreen" allow="geolocation *; microphone *; camera *; midi *;
encrypted-media *" title="PREPOSITIONS OF PLACE S2"> </iframe>
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfPlacequestions_and_answersmedium'"
                                class="h5p-container">
                                <iframe src="https://h5p.org/h5p/embed/1456175" width="1090" height="336" frameborder="0"
                                    allowfullscreen="allowfullscreen" allow="geolocation *; microphone *; camera *; midi *;
encrypted-media *" title="PREPOSITIONS OF PLACE Q2"></iframe>
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfPlacelecturemedium'">
                                <img src="../../learning_resources/placelecturemedium.png" alt="imagen"
                                    style="max-height: 100%;">
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfPlaceIllustrationhigh'">
                                <img src="../../learning_resources/placeilustrationhigh.png" alt="imagen"
                                    style="max-height: 100%;">
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfPlacesimulationshigh'">
                                <iframe src="https://h5p.org/h5p/embed/1462747" width="1091" height="496" frameborder="0"
                                    allowfullscreen="allowfullscreen"
                                    allow="geolocation *; microphone *; camera *; midi *; encrypted-media *"
                                    title="simulacion p.place nivel alto"></iframe>
                            </div>
                            ...
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfPlacelecturehigh'">
                                <img src="../../learning_resources/placelecturehigh.png" alt="imagen"
                                    style="max-height: 100%;">
                            </div>
                            ...
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfMovementsimulationslow'">
                                <iframe src="https://h5p.org/h5p/embed/1462763" width="1091" height="949" frameborder="0"
                                    allowfullscreen="allowfullscreen"
                                    allow="geolocation *; microphone *; camera *; midi *; encrypted-media *"
                                    title="SIMULATION Preposition movement nivel 1"></iframe>
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfMovementquestions_and_answerslow'">
                                <iframe src="https://h5p.org/h5p/embed/1462764" width="1091" height="337" frameborder="0"
                                    allowfullscreen="allowfullscreen"
                                    allow="geolocation *; microphone *; camera *; midi *; encrypted-media *"
                                    title="QUESTION preposition MOVEMENT nivel 1"></iframe>
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfMovementlecturelow'">
                                <img src="../../learning_resources/movementlecturelow.png" alt="imagen"
                                    style="max-height: 100%;">
                            </div>
                            ...
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfMovementsimulationsmedium'">
                                <iframe src="https://h5p.org/h5p/embed/1462761" width="1091" height="949" frameborder="0"
                                    allowfullscreen="allowfullscreen"
                                    allow="geolocation *; microphone *; camera *; midi *; encrypted-media *"
                                    title="Preposition movement nivel 2"></iframe>
                            </div>
                            <div
                                v-else-if="resources[currentIndex].url == 'PrepositionOfMovementquestions_and_answersmedium'">
                                <iframe src="https://h5p.org/h5p/embed/1462765" width="1091" height="337" frameborder="0"
                                    allowfullscreen="allowfullscreen"
                                    allow="geolocation *; microphone *; camera *; midi *; encrypted-media *"
                                    title="QUESTION preposition MOVEMENT nivel 2"></iframe>
                            </div>
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfMovementlecturemedium'">
                                <img src="../../learning_resources/movementlecturemedium.png" alt="imagen"
                                    style="max-height: 100%;">
                            </div>
                            ...
                            <div v-else-if="resources[currentIndex].url == 'PrepositionOfMovementsimulationshigh'">
                                <iframe src="https://h5p.org/h5p/embed/1462758" width="1091" height="949" frameborder="0"
                                    allowfullscreen="allowfullscreen"
                                    allow="geolocation *; microphone *; camera *; midi *; encrypted-media *"
                                    title="Preposition movement nivel 3"></iframe>
                            </div>
                            <div
                                v-else-if="resources[currentIndex].url == 'PrepositionOfMovementquestions_and_answershigh'">
                                <iframe src="https://h5p.org/h5p/embed/1462766" width="1091" height="337" frameborder="0"
                                    allowfullscreen="allowfullscreen"
                                    allow="geolocation *; microphone *; camera *; midi *; encrypted-media *"
                                    title="QUESTION preposition MOVEMENT nivel 3"></iframe>
                            </div>
